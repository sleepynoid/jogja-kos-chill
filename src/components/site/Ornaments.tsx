...
export const TumpalDivider = ({ className = "" }: { className?: string }) => (
  <div
    className={`w-full flex justify-center overflow-hidden py-4 select-none pointer-events-none ${className}`}
  >
    <svg
      className="w-full max-w-lg h-8 text-brand-accent/40"
      viewBox="0 0 400 30"
      fill="currentColor"
      xmlns="http://www.w3.org/2000/svg"
...
export const PatraCorner = ({
  ...
  return (
    ...
    >
      ...
      <path
        d="M5,5 Q15,25 25,25 Q15,35 5,45 L5,35 Q10,25 5,15 Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
      />
