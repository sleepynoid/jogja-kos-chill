        ...
        <AnimatePresence mode="popLayout">
          {wishlistItems.length > 0 ? (
              ...
              {wishlistItems.map((item) => {
                ...
                return (
                  <motion.div
                    ...
                    key={item.id}
                    className="group bg-card rounded-[4rem] overflow-hidden border border-border shadow-sm hover:shadow-2xl hover:shadow-brand-accent/5 transition-all flex flex-col"
                  >
                    <div className="relative aspect-[4/3] overflow-hidden">
                      ...
                      <button
                        ...
                        className="absolute top-8 right-8 w-14 h-14 bg-black/20 backdrop-blur-md rounded-full flex items-center justify-center text-white border border-white/10 shadow-lg hover:bg-red-500 hover:text-white transition-all opacity-0 group-hover:opacity-100 cursor-pointer"
                    ...
                    <div className="p-10 space-y-8 flex-1 flex flex-col justify-between">
                      <div className="space-y-4 flex-1">
                        <div className="flex justify-between items-start gap-4">
                          ...
                          <div className="flex items-center gap-1.5 bg-secondary px-3 py-1.5 rounded-xl text-brand-accent font-bold text-xs shrink-0 border border-border">
                            <Star size={14} className="fill-brand-accent" /> {item.rating}
                          </div>
                        </div>
                        <p className="text-muted-foreground text-sm flex items-center gap-2 font-medium italic">
                      ...
                      <div className="pt-8 border-t border-border flex justify-between items-end">
                        <div className="space-y-1">
                          ...
                          <p className="text-2xl font-display font-bold text-foreground">
                            ...
                            <span className="text-xs font-normal text-muted-foreground ml-1 italic">
                              / bln
                            </span>
                          </p>
                        </div>
            ...
            <motion.div
              ...
              className="text-center py-40 space-y-10 bg-card rounded-[4rem] border border-dashed border-border"
            >
              <div className="w-32 h-32 bg-secondary rounded-full flex items-center justify-center mx-auto text-muted-foreground ring-8 ring-secondary/50">
              ...
              <Link
                to="/katalog"
                className="inline-flex items-center gap-4 bg-primary text-primary-foreground px-10 py-5 rounded-[2rem] font-bold hover:scale-[1.02] hover:shadow-xl hover:shadow-brand-accent/10 transition-all uppercase tracking-widest text-xs cursor-pointer border border-border"
              >
